...
export const state_centers = {
  "Alabama": { lat: 32.806671, lng: -86.791130, abbrev: "AL" },
  "Alaska": { lat: 61.370716, lng: -152.404419, abbrev: "AK" },
  "Arizona": { lat: 33.729759, lng: -111.431221, abbrev: "AZ" },
  "Arkansas": { lat: 34.969704, lng: -92.373123, abbrev: "AR" },
  "California": { lat: 36.116203, lng: -119.681564, abbrev: "CA" },
  "Colorado": { lat: 39.059811, lng: -105.311104, abbrev: "CO" },
  "Connecticut": { lat: 41.597782, lng: -72.755371, abbrev: "CT" },
  "Delaware": { lat: 39.318523, lng: -75.507141, abbrev: "DE" },
  "Florida": { lat: 27.766279, lng: -81.686783, abbrev: "FL" },
  "Georgia": { lat: 33.040619, lng: -83.643074, abbrev: "GA" },
  "Hawaii": { lat: 21.094318, lng: -157.498337, abbrev: "HI" },
  "Idaho": { lat: 44.240459, lng: -114.478828, abbrev: "ID" },
  "Illinois": { lat: 40.349457, lng: -88.986137, abbrev: "IL" },
  "Indiana": { lat: 39.849426, lng: -86.258278, abbrev: "IN" },
  "Iowa": { lat: 42.011539, lng: -93.210526, abbrev: "IA" },
  "Kansas": { lat: 38.526600, lng: -96.726486, abbrev: "KS" },
  "Kentucky": { lat: 37.668140, lng: -84.670067, abbrev: "KY" },
  "Louisiana": { lat: 31.169546, lng: -91.867805, abbrev: "LA" },
  "Maine": { lat: 44.693947, lng: -69.381927, abbrev: "ME" },
  "Maryland": { lat: 39.063946, lng: -76.802101, abbrev: "MD" },
  "Massachusetts": { lat: 42.230171, lng: -71.530106, abbrev: "MA" },
  "Michigan": { lat: 43.326618, lng: -84.536095, abbrev: "MI" },
  "Minnesota": { lat: 45.694454, lng: -93.900192, abbrev: "MN" },
  "Mississippi": { lat: 32.741646, lng: -89.678696, abbrev: "MS" },
  "Missouri": { lat: 38.456085, lng: -92.288368, abbrev: "MO" },
  "Montana": { lat: 46.921925, lng: -110.454353, abbrev: "MT" },
  "Nebraska": { lat: 41.125370, lng: -98.268082, abbrev: "NE" },
  "Nevada": { lat: 38.313515, lng: -117.055374, abbrev: "NV" },
  "New Hampshire": { lat: 43.452492, lng: -71.563896, abbrev: "NH" },
  "New Jersey": { lat: 40.298904, lng: -74.521011, abbrev: "NJ" },
  "New Mexico": { lat: 34.840515, lng: -106.248482, abbrev: "NM" },
  "New York": { lat: 42.165726, lng: -74.948051, abbrev: "NY" },
  "North Carolina": { lat: 35.630066, lng: -79.806419, abbrev: "NC" },
  "North Dakota": { lat: 47.528912, lng: -99.784012, abbrev: "ND" },
  "Ohio": { lat: 40.388783, lng: -82.764915, abbrev: "OH" },
  "Oklahoma": { lat: 35.565342, lng: -96.928917, abbrev: "OK" },
  "Oregon": { lat: 44.572021, lng: -122.070938, abbrev: "OR" },
  "Pennsylvania": { lat: 40.590752, lng: -77.209755, abbrev: "PA" },
  "Rhode Island": { lat: 41.680893, lng: -71.511780, abbrev: "RI" },
  "South Carolina": { lat: 33.856892, lng: -80.945007, abbrev: "SC" },
  "South Dakota": { lat: 44.299782, lng: -99.438828, abbrev: "SD" },
  "Tennessee": { lat: 35.747845, lng: -86.692345, abbrev: "TN" },
  "Texas": { lat: 31.054487, lng: -97.563461, abbrev: "TX" },
  "Utah": { lat: 40.150032, lng: -111.862434, abbrev: "UT" },
  "Vermont": { lat: 44.045876, lng: -72.710686, abbrev: "VT" },
  "Virginia": { lat: 37.769337, lng: -78.169968, abbrev: "VA" },
  "Washington": { lat: 47.400902, lng: -121.490494, abbrev: "WA" },
  "West Virginia": { lat: 38.491226, lng: -80.954453, abbrev: "WV" },
  "Wisconsin": { lat: 44.268543, lng: -89.616508, abbrev: "WI" },
  "Wyoming": { lat: 42.755966, lng: -107.302490, abbrev: "WY" }
}
